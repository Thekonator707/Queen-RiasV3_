...
module.exports = {
    ...
    ownerNumber: process.env.OWNER_NUMBER || "2349168764213", // Your WhatsApp number

    sudo: process.env.SUDO ? process.env.SUDO.split(",") : ["2349168764213"," 2349168764213"], // People Who can use the bot even in Private mode
